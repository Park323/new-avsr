...
# Áß¼º ¸®½ºÆ®. 00 ~ 20
JUNGSUNG_LIST = ['¤¿', '¤À', '¤Á', '¤Â', '¤Ã', '¤Ä', '¤Å', '¤Æ', '¤Ç', '¤È', '¤É', '¤Ê', '¤Ë', '¤Ì', '¤Í', '¤Î', '¤Ï', '¤Ð', '¤Ñ', '¤Ò', '¤Ó']

# Á¾¼º ¸®½ºÆ®. 00 ~ 27 + 1(1°³ ¾øÀ½)
JONGSUNG_LIST = [None, '¤¡', '¤¢', '¤£', '¤¤', '¤¥', '¤¦', '¤§', '¤©', '¤ª', '¤«', '¤¬', '¤­', '¤®', '¤¯', '¤°', '¤±', '¤²', '¤´', '¤µ', '¤¶', '¤·', '¤¸', '¤º', '¤»', '¤¼', '¤½', '¤¾']
...
def char2grp(test_keyword):
    ...
    for keyword in split_keyword_list:
        # ÇÑ±Û ¿©ºÎ check ÈÄ ºÐ¸®
        if re.match('.*[°¡-ÆR]+.*', keyword) is not None: # '.*[¤¡-¤¾¤¿-¤Ó°¡-ÆR]+.*'
            char_code = ord(keyword) - BASE_CODE
            char1 = int(char_code / CHOSUNG)
            result.append(CHOSUNG_LIST[char1])
            #print('ÃÊ¼º : {}'.format(CHOSUNG_LIST[char1]))
            char2 = int((char_code - (CHOSUNG * char1)) / JUNGSUNG)
            result.append(JUNGSUNG_LIST[char2])
            #print('Áß¼º : {}'.format(JUNGSUNG_LIST[char2]))
            ...
            #print('Á¾¼º : {}'.format(JONGSUNG_LIST[char3]))
        else:
